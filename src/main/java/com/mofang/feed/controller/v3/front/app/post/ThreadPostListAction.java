package com.mofang.feed.controller.v3.front.app.post;
...
public class ThreadPostListAction extends AbstractActionExecutor
{
	...
	protected ResultValue exec(HttpRequestContext context) throws Exception
	{
		...
		if(1 == type)    ///只看楼主
			return logic.getHostPostList(threadId, pageNum, pageSize, userId, RequestFrom.APP);
		else
			return logic.getThreadPostList(threadId, pageNum, pageSize, userId, RequestFrom.APP);
	}
}