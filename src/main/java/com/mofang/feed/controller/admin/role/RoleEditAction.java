 ...
 *
 */
public class RoleEditAction extends AbstractActionExecutor
{
	...
	protected ResultValue exec(HttpRequestContext context) throws Exception
	{
		...
		///参数检查
		if(roleId <= 0 || StringUtil.isNullOrEmpty(roleName) || StringUtil.isNullOrEmpty(privileges))
		{
			result.setCode(ReturnCode.CLIENT_REQUEST_DATA_IS_INVALID);
			result.setMessage(ReturnMessage.CLIENT_REQUEST_DATA_IS_INVALID);
			return result;
		...
		return logic.edit(roleInfo, operatorId);
	}
}