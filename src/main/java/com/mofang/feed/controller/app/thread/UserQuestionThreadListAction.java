 ...
 *
 */
@Action(url="feed/v2/myquestion")
public class UserQuestionThreadListAction extends AbstractActionExecutor
{
	...
	protected ResultValue exec(HttpRequestContext context) throws Exception
	{
		...
		return logic.getUserQuestionThreadList(userId, pageNum, pageSize);
	}
}