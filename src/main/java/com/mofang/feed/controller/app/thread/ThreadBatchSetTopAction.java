 ...
 *
 */
@Action(url = "feed/v2/threads/batch_top")
public class ThreadBatchSetTopAction extends AbstractActionExecutor
{
	...
	protected ResultValue exec(HttpRequestContext context) throws Exception
	{
		...
		{
			result = logic.setTop(Long.parseLong(strThreadId), operatorId, reason);
